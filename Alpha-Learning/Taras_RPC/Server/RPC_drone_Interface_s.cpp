...
static const SERVER_ROUTINE cv_drone_int_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)_askHoop,
    (SERVER_ROUTINE)_askHoopX,
    (SERVER_ROUTINE)_askHoopY,
    (SERVER_ROUTINE)_askHoopRa,
    (SERVER_ROUTINE)_askHoopRb,
    (SERVER_ROUTINE)_askQR,
    (SERVER_ROUTINE)_askQRX,
    (SERVER_ROUTINE)_askQRY,
    (SERVER_ROUTINE)_askHeight,
    (SERVER_ROUTINE)_askMagnetometerOrientation,
    (SERVER_ROUTINE)_askAngle,
    (SERVER_ROUTINE)_tellMove,
    (SERVER_ROUTINE)_tellTurn,
    (SERVER_ROUTINE)_tellSetSpeed,
    (SERVER_ROUTINE)_tellForceMove,
    (SERVER_ROUTINE)_tellForceTurn,
    (SERVER_ROUTINE)_tellForceSetSpeed
    };
